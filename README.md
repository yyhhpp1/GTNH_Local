# Migrating to a New Instance (Recommended)  

This method involves copying files from the current GTNH instance into a new GTNH instance. This is also the only way to transfer saves between launchers.  

1. Setup the new launcher and/or GTNH instance. Ensure it can run without issues before making any changes.  
